...
# Researcher — team_speed_run

## Your job

Run the autoresearch invocation for team_speed_run ONCE per iteration, then crystallize the findings into a strategy brief at `_inbox/research_brief.md`.
